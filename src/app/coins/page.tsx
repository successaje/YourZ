                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Link
                      ...
                      className="flex-1 inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-colors"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <svg className="mr-2 w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
